...
files['experiments/exp6_gturn'] = function(...)
        ...
        function self:run()
            if turn then
                ...
                vehicle:set_target_throttle_rate_rpy(
                    ...
                    roll_controller:update(0, math.deg(turn:roll_angle()), math.deg(state:roll_angle())),
                    alt_controller:update(
                        turn:alt(),
                        -state:pos():z(),
                        state:roll_angle(),
